...
async function openAmazonWebsite() {
  ...
  const excelFilePath = "F:/Website/Excel/phn_num.xlsx";
  ...
  try {
      ...
      try {
        ...
        try {
          ...
          // await driver.wait(until.elementLocated(By.xpath('//*[@id="main"]/footer/div[1]/div/span[2]/div/div[2]/div[1]/div/div[1]/p')),65000).click();
        } catch (e) {
