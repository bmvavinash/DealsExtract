    ...
    try {
      ...
      // if (Input[i] != undefined)
        ...
        if((extract=="Telegram" && !(Input[i].from.includes("All1App"))) || extract=="File" || extract=="Excel"){
            ...
            try {
              if(photo != "" && urlvalue1.length != 0 && urlvalue1!="" && (pricenum > 0 || (extract=="Excel" && extractData=="productlinks" && dealPrice>0)) && (disco > 0 || (extract=="Excel" && extractData=="productlinks" && totalDiscount>0)) ){
              ...
              //   jsonFileName = productCategory
              // }
              if((photo != "" && urlvalue1.length != 0 && urlvalue1!="" && (pricenum > 0 || (extract=="Excel" && extractData=="productlinks" && dealPrice>0)) && (disco > 0 || (extract=="Excel" && extractData=="productlinks" && totalDiscount>0))) || (extractData == "categorylinks")){
