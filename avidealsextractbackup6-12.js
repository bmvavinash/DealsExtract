...
async function example() {
  ...
  // let env="stage"
  let env="prod"
  // let extractData="Telegram"// not using
  ...
  const excelFilePath = 'C:/Users/avina/Downloads/Telegram Desktop/Hot Deals.xlsx';
...
// const inputData = [1, 2, 3, 1, 2, 4, 5, 1, 2, 3];
  ...
  let access_token = await getAccessToken(env,extract);
