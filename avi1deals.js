...
async function earnkaro(strUrl){
...
async function earnkaroLogin(driver){
...
async function amazonLogin(driver){
    //Amazon Login
...
async function getAjioItem(driver) {
...
async function getMyntraItem(driver) {
...
let itemType = "Flipkart";

async function getFlipkartItem(driver,Links) {
  // return new Promise(async (resolve, reject) => {
  itemType = "Flipkart"
  console.log("Links are ",Links)
  console.log("In getFlipkartItem Function")
  await driver.get(Links)
  await driver.get("https://google.com")
  await driver.get(Links)
  // await driver.get("https://myntra.com")
  flipkart = true;
  try{
    try{
            ...
            try {
              ...
              if (!Input[i].text_entities[j].type.includes("link")) {
                ...
                if(strUrl.includes("flipkart")){
                  console.log("Calling Flipkart")
                  // await getFlipkartItem(driver,Links)
                  await getFlipkartItem(driver,Input[i].text_entities[j].text)
              }
                ...
                //earnlink not working for earnkaro
            //    earnlink = earnkaro();
              }
